...
import { idlFactory } from './tetris_frontend.did.js';
export { idlFactory } from './tetris_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_TETRIS_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./tetris_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the tetris_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./tetris_frontend.did.js")._SERVICE>}
 */
export const tetris_frontend = createActor(canisterId);
