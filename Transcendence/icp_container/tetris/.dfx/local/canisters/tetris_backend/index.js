...
import { idlFactory } from './tetris_backend.did.js';
export { idlFactory } from './tetris_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_TETRIS_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./tetris_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the tetris_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./tetris_backend.did.js")._SERVICE>}
 */
export const tetris_backend = createActor(canisterId);
